...
<section class="slider">
    <div class="slider_one">
        <div class="col-1">
            ...
            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color:#fff;" class="swiper myInvent2">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img src="./img-20250422T181147Z-001/img/invectory/single-2.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./img-20250422T181147Z-001/img/invectory/single-3.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./img-20250422T181147Z-001/img/invectory/single-4.jpg" alt="">
                    </div> 
                </div>
            ...
            <div class="swiper myInvent1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="./Golf/2.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Golf/3.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Golf/4.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Golf/5.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-1">
            <h5>Description</h5>
            <p class="dec">The 2025 Volkswagen Golf 8 Facelift R-Line is a refined and sporty hatchback that blends
                everyday practicality with premium features. With its bold R-Line styling, advanced driver assistance
                systems, and updated digital cockpit, it offers a dynamic driving experience wrapped in German
                engineering. Perfect for city drives or long journeys, the Golf 8 continues to set the standard
                in its class.</p>
            <p class="dec"></p>

            <h5>Car Features</h5>
            <div class="features">
                <p class="fe"><i class="bx bx-check-shield"></i>Digital cockpit screen.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>10" touchscreen.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>LED IQ.Light.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>R-Line wheels.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Dual-zone AC.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Adaptive cruise.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Wireless CarPlay.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Keyless start.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Park Assist.</p>
            </div>
        </div>
    </div>
    <div class="slider_two">
        <div class="col-2">
            <h3><span>>Price:</span> 340,000 MAD</h3>
        </div>
        <a href="commande.php?id=4"><button class="load">Shop Now </button></a>
        <div class="col-2">
