    ...
    <div class="slider_one">
        <div class="col-1">
            ...
            <div class="swiper myInvent1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="./Mazda/1.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Mazda/2.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Mazda/3.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Mazda/4.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-1">
            <h5>Description</h5>
            <p class="dec">The 2025 Mazda CX-3 is a compact
                SUV that combines sleek design, advanced technology, and efficient performance. With its refined interior
                 and responsive handling, it offers a comfortable and engaging driving experience, perfect for urban 
                 adventures.</p>
            <p class="dec"></p>

            <h5>Car Features</h5>
            <div class="features">
                <p class="fe"><i class="bx bx-check-shield"></i>1.5L SkyActiv engine.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>6-speed automatic.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>LED lights.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>16" alloy wheels.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>7" touchscreen.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Bluetooth audio.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Rearview camera.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>ABS + stability.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>5.2L/100km fuel use.</p>
            </div>
        </div>
    </div>
    <div class="slider_two">
        <div class="col-2">
            <h3><span>>Price:</span> 330,000 MAD</h3>
        </div>
        <a href="commande.php?id=9"><button class="load">Shop Now </button></a>
        <div class="col-2">
