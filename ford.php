    ...
    <div class="slider_one">
        <div class="col-1">
            ...
            <div class="swiper myInvent1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="./Ford/2.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Ford/3.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Ford/4.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Ford/5.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-1">
            <h5>Description</h5>
            <p class="dec">The 2025 Ford Next-Gen Ranger XLT is a robust and versatile pickup truck designed for both
                work and leisure. With its powerful 2.0L Bi-Turbo diesel engine, advanced safety features, and modern 
                technology, it delivers a comfortable and confident driving experience on and off the road.</p>
            <p class="dec"></p>

            <h5>Car Features</h5>
            <div class="features">
                <p class="fe"><i class="bx bx-check-shield"></i>10" SYNC® 4A screen.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Wireless CarPlay/Android.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>LED C-Clamp lights.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>17" alloy wheels.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Dual-zone AC.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Rearview camera.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Terrain modes.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Safety features.</p>
                <p class="fe"><i class="bx bx-check-shield"></i>Cargo step.</p>
            </div>
        </div>
    </div>
    <div class="slider_two">
        <div class="col-2">
            <h3><span>>Price:</span> 510,000 MAD</h3>
        </div>
        <a href="commande.php?id=10"><button class="load">Shop Now </button></a>
        <div class="col-2">
...
<!-- Exemple pour une page listant les voitures -->
<?php
