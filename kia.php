...
<section class="slider">
    <div class="slider_one">
        <div class="col-1">
            ...
            <div class="swiper myInvent1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="./kia/2.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./kia/3.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./kia/4.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./kia/5.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-1">
            <h5>Description</h5>
            <p class="dec">The Kia Sportage X-Line is a stylish and sporty SUV that blends modern design with practicality
                 features. It offers a comfortable ride, advanced safety technology, and a versatile interior perfect for
                  both city driving and outdoor adventures.</p>
            <p class="dec"></p>
    ...
    <div class="slider_two">
        ...
        <a href="commande.php?id=7"><button class="load">Shop Now </button></a>
        <div class="col-2">
