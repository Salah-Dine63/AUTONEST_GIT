                        ...
                        <li><a href="#">Pages<i class="bx bx-chevron-down"></i></a>
                            <ul class="drop-down">
                               ...
                               <!-- <li><a href="#">Car Listing<i class="bx bx-chevron-down chev"></i></a>
                                ...
                                <li><a href="login.php">My Account<i class="bx bx-chevron-down chev"></i></a>
...
<section class="slider">
    <div class="slider_one">
        <div class="col-1">
            ...
            <div class="swiper myInvent1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="./mercedes S-class/2.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./mercedes S-class/3.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./mercedes S-class/4.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./mercedes S-class/5.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-1">
            <h5>Description</h5>
            <p class="dec">The Mercedes S-Class is a high-end luxury sedan that combines elegant design, cutting-edge
                 technology, and top-tier comfort. With its powerful engine, smooth performance, and premium interior
                  features, it delivers a first-class driving experience for both drivers and passengers.</p>
            <p class="dec"></p>
    ...
    <div class="slider_two">
        <div class="col-2">
            <h3><span>Price:</span> 1,630,000 MAD</h3>
        </div>
        <a href="commande.php?id=5"><button class="load">Shop Now </button></a>
        <div class="col-2">
