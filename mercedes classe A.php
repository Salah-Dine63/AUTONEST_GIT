...
<section class="slider">
    <div class="slider_one">
        <div class="col-1">
            ...
            <div class="swiper myInvent1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="./Mercedes/5.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Mercedes/6.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Mercedes/7.jpg" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="./Mercedes/8.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-1">
            <h5>Description</h5>
            <p class="dec">The 2025 Mercedes-Benz A 200 d AMG Line is a premium diesel hatchback that combines
                 dynamic AMG styling with cutting-edge technology. With a refined interior, sporty design, and
                 efficient performance, it delivers both comfort and excitement for everyday driving.</p>
            <p class="dec"></p>
    ...
    <div class="slider_two">
        <div class="col-2">
            <h3><span>Price:</span> 486.326 MAD</h3>
        </div>
        <a href="commande.php?id=3"><button class="load">Shop Now </button></a>
        <div class="col-2">
